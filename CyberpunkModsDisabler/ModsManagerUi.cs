...
internal class ModsManagerUi
{
    ...
    public void Init()
    {
        ...
        {
            if (_modsManager.ModsStatus == ModsStatus.Enabled) _modsManager.MoveMods();
            else if (_modsManager.ModsStatus == ModsStatus.Disabled) _modsManager.MoveMods(false);
    ...
    private void MoveModsToSelectedDest()
    {
        ...
        {
            case '1':
                _modsManager.MoveMods();
                break;
            case '2':
                _modsManager.MoveMods(false);
                break;
        }
